...
/// <see cref="GiftToken"/> and <see cref="ArtistName"/> for a received gift (C22), none for an
/// accept. <see cref="ActorHandle"/> is the actor's public handle, looked up from their user row.
/// <see cref="Read"/> is true once the recipient has marked it read.
/// </summary>
