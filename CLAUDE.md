...
**Estado (2026-07-15)**: **feature-complete y DESPLEGADO** en `https://grimoire.drheavymetal.com`. Catálogo real de **206 887 artistas** (dump de MusicBrainz D5, **sin clásica** tras D50), motor a escala, escucha online JIT, rediseño visual v2.

**Lo último está en `docs/MEMORY.md` §6c — léelo antes de tocar nada.** Sesión larga y autónoma del 2026-07-15: **Metal Archives scraper construido y CORRIENDO** (importa temática lírica; bug clave: MA 403ea HTTP/1.1, hay que hablar HTTP/2 — D48), **pase de Last.fm relanzado con tags** (los dos crawls corren en el server, `unless-stopped`, resumibles), **música clásica ELIMINADA** (D50, datos+código), y tres fixes de producto: **corrosión de Redaction estaba invertida** (D51), **Atlas colgaba el PC** por enviar 175k puntos (capado a 8000), **trayectoria del Espejo en blanco** (reescrita a depth-en-tiempo). Dos features nuevas: **Rito por género opcional** (D52, sigue ciego) y **enlaces a Spotify/Apple/Tidal/YouTube Music**. `docs/MEMORY.md` §6b es la sesión anterior (2026-07-14: los cuatro bugs de prod, D46, la 1ª respuesta de MA, D47 nunca de pago).
